...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Build a deterministic landscape report from product intelligence records.")
    ...
    if args.collection_dir is not None:
        ...
        output_dir = args.output_dir or args.collection_dir / "landscape"
    else:
        records_path = args.product_intelligence_records
        output_dir = args.output_dir or Path("artifacts/landscape-report")
